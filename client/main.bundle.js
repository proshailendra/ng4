...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            ...
            imports: [
                __WEBPACK_IMPORTED_MODULE_0__angular_platform_browser__["a" /* BrowserModule */], __WEBPACK_IMPORTED_MODULE_2__angular_http__["b" /* HttpModule */], __WEBPACK_IMPORTED_MODULE_4__app_routing__["a" /* AppRoutingModule */]
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_6__services_auth_service__["a" /* AuthService */], __WEBPACK_IMPORTED_MODULE_5__auth_guard__["b" /* UserAuthGuard */], __WEBPACK_IMPORTED_MODULE_5__auth_guard__["a" /* AdminAuthGuard */], __WEBPACK_IMPORTED_MODULE_7__models_cart__["a" /* Cart */]],
...
var routes = [
    ...
    { path: 'user', loadChildren: './user/user.module#UserModule', canActivate: [__WEBPACK_IMPORTED_MODULE_2__auth_guard__["b" /* UserAuthGuard */]] },
    { path: 'admin', loadChildren: './admin/admin.module#AdminModule', canActivate: [__WEBPACK_IMPORTED_MODULE_2__auth_guard__["a" /* AdminAuthGuard */]] }
];
...
var AdminAuthGuard = /** @class */ (function () {
    ...
    AdminAuthGuard.prototype.canActivate = function () {
        ...
        else if (this.user.roles.indexOf('Admin') > -1) {
            return true;
        }
        else {
...
var UserAuthGuard = /** @class */ (function () {
    ...
    UserAuthGuard.prototype.canActivate = function () {
        ...
        else if (this.user.roles.indexOf('User') > -1) {
            return true;
        }
        else {
            this.router.navigate(['unauthorize']);
...
var environment = {
    ...
    successUrl: 'https://ng4pm.herokuapp.com/paymentstatus',
    failedUrl: 'https://ng4pm.herokuapp.com/paymentstatus',
    key: 'gtKFFx',
    salt: 'eCwWELxi'
};
