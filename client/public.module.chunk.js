    ...
    CartComponent.prototype.checkout = function () {
        ...
        if (this.user !== undefined) {
            ...
            this.storeService.SaveCart(this.cart).subscribe(function (res) {
                if (res !== undefined) {
                    _this.cart.checkoutPayUmoney(res.name, _this.user);
                }
            });
        }
        else {
            ...
            this.authService.ValidateUser(this.userLogin).subscribe(function (res) {
                ...
                if (user != null) {
                    if (_this.ref !== undefined && _this.ref !== '') {
                        ...
                        if (user.roles.length > 0 && user.roles.indexOf('Admin') > -1) {
                            return _this.router.navigate(['admin']);
                        }
                        else if (user.roles.length > 0 && user.roles.indexOf('User') > -1) {
...
var PublicLayoutComponent = /** @class */ (function (_super) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__public_layout__ = __webpack_require__("../../../../../src/app/public/public.layout.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__public_routing__ = __webpack_require__("../../../../../src/app/public/public.routing.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__cart_cart_component__ = __webpack_require__("../../../../../src/app/public/cart/cart.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var PublicModule = /** @class */ (function () {
    ...
    PublicModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_3__public_layout__["a" /* PublicLayoutComponent */], __WEBPACK_IMPORTED_MODULE_4__public_routing__["b" /* routedComponents */], __WEBPACK_IMPORTED_MODULE_8__cart_cart_component__["a" /* CartComponent */]
            ],
            imports: [__WEBPACK_IMPORTED_MODULE_0__angular_common__["b" /* CommonModule */], __WEBPACK_IMPORTED_MODULE_2__angular_forms__["a" /* FormsModule */], __WEBPACK_IMPORTED_MODULE_6__angular_http__["b" /* HttpModule */], __WEBPACK_IMPORTED_MODULE_4__public_routing__["a" /* PublicRoutingModule */]],
            providers: [__WEBPACK_IMPORTED_MODULE_5__services_auth_service__["a" /* AuthService */], __WEBPACK_IMPORTED_MODULE_7__services_store_service__["a" /* StoreService */]],
            bootstrap: [__WEBPACK_IMPORTED_MODULE_3__public_layout__["a" /* PublicLayoutComponent */]]
        })
    ], PublicModule);
    return PublicModule;
}());
...
var routes = [
    {
        path: '', component: __WEBPACK_IMPORTED_MODULE_4__public_layout__["a" /* PublicLayoutComponent */], children: [
...
var routedComponents = [__WEBPACK_IMPORTED_MODULE_2__store_store_component__["a" /* StoreComponent */], __WEBPACK_IMPORTED_MODULE_3__login_login_component__["a" /* LoginComponent */], __WEBPACK_IMPORTED_MODULE_5__unauthorize_unauthorize_component__["a" /* UnauthorizeComponent */]];
...
module.exports = "<h2>My Store</h2>\n\n<table class=\"table table-bordered\">\n  <thead>\n    <tr>\n      <th>SNo.</th>\n      <th>Product</th>\n      <th>Price</th>\n      <th>Actions</th>\n    </tr>\n  </thead>\n  <tbody>\n    <tr *ngFor=\"let item of products;let i=index\">\n      <td>{{i+1}}</td>\n      <td>\n        <img src=\"{{item.file}}\" [alt]=\"item.name\" height=\"220px\"/>\n      </td>\n      <td>{{item.unitPrice}}</td>\n      <td>\n        <button type=\"button\" (click)=\"cart.addToCart(item.productId,item.name,item.unitPrice,1)\" class=\"btn btn-primary\">Add To Cart</button>\n      </td>\n    </tr>\n  </tbody>\n</table>\n"
...
module.exports = "<h3>You are are not authorize to access this page!</h3>"
